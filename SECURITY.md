...
We will support the latest stable release of `presentation-template`. Please
...
If you discover a security vulnerability in `presentation-template`, please
report it using **GitHub's private vulnerability reporting feature**:

<!-- prettier-ignore-start -->

1. Go to the [Security](https://github.com/isaac-cf-wong/presentation-template/security) tab of this repository
2. Click **"Report a vulnerability"**
3. Fill out the vulnerability report form with:
    - A description of the vulnerability
    - Steps to reproduce
    - Affected versions
    - Your operating system, Node.js version, and browser
...
you for helping make `presentation-template` better and safer!
